...
var apiURLstring = 'https://api.openweathermap.org/data/2.5/weather?zip=83276&APPID=2e107688d57075d314ca40a4c101e340&units=imperial';
...
var forecastRequestURL = 'https://api.openweathermap.org/data/2.5/forecast?zip=83276&APPID=2e107688d57075d314ca40a4c101e340&units=imperial';
...
function showForecast(forecastData) {
     ...
     document.getElementById("sodaSprings-day0").innerHTML = fcstDaysArr[0];
     document.getElementById("sodaSprings-day1").innerHTML = fcstDaysArr[1];
     document.getElementById("sodaSprings-day2").innerHTML = fcstDaysArr[2];
     document.getElementById("sodaSprings-day3").innerHTML = fcstDaysArr[3];
     document.getElementById("sodaSprings-day4").innerHTML = fcstDaysArr[4];
     document.getElementById("sodaSprings-high0").innerHTML = fcstHighArr[0].toFixed(1) + "&#8457";
     document.getElementById("sodaSprings-high1").innerHTML = fcstHighArr[1].toFixed(1) + "&#8457";
     document.getElementById("sodaSprings-high2").innerHTML = fcstHighArr[2].toFixed(1) + "&#8457";
     document.getElementById("sodaSprings-high3").innerHTML = fcstHighArr[3].toFixed(1) + "&#8457";
     document.getElementById("sodaSprings-high4").innerHTML = fcstHighArr[4].toFixed(1) + "&#8457";
