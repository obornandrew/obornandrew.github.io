...
function showForecast(forecastData) {
     ...
     document.getElementById("preston-day0").innerHTML = fcstDaysArr[0];
     document.getElementById("preston-day1").innerHTML = fcstDaysArr[1];
     document.getElementById("preston-day2").innerHTML = fcstDaysArr[2];
     document.getElementById("preston-day3").innerHTML = fcstDaysArr[3];
     document.getElementById("preston-day4").innerHTML = fcstDaysArr[4];
     document.getElementById("preston-high0").innerHTML = fcstHighArr[0].toFixed(1) + "&#8457";
     document.getElementById("preston-high1").innerHTML = fcstHighArr[1].toFixed(1) + "&#8457";
     document.getElementById("preston-high2").innerHTML = fcstHighArr[2].toFixed(1) + "&#8457";
     document.getElementById("preston-high3").innerHTML = fcstHighArr[3].toFixed(1) + "&#8457";
     document.getElementById("preston-high4").innerHTML = fcstHighArr[4].toFixed(1) + "&#8457";
